...
DATABASES = {
    'default': {
        ...
        'NAME': 'rvonnet',
        'USER': 'super_postgres_user',
        'PASSWORD': 'ragini@2007$#vijayamma@1976$!adinarayana@1969!#',
        'HOST': 'localhost',
        'PORT': '',
    }
}
...
STATICFILES_DIRS = [
    ...
    os.path.join(PROJECT_PATH, 'product/static'),
    os.path.join(PROJECT_PATH, 'service/static'),
    os.path.join(PROJECT_PATH, 'accounts/static'),
    ]

# Use this only for development not for production 
MEDIA_URL = '/media/'
